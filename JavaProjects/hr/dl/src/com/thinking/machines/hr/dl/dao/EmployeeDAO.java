...
if(isDesignationCodeValid==false) throw new DAOException("Invalid code : "+designationCode);
...
randomAccessFile.close();
throw new DAOException("Invalid PAN nummber : "+panNumber);
}catch(IOException ioException)
{
throw new DAOException(ioException.getMessage());
}
...
randomAccessFile.close();
throw new DAOException("Invalid Aadhar card nummber : "+aadharCardNumber);
}catch(IOException ioException)
{
throw new DAOException(ioException.getMessage());
}
